  ...
  return (
    <>
      ...
      >
        ...
        <Skills name="HTML" x="-21vw" y="2vw" />
        <Skills name="CSS" x="-10vw" y="-10vw" />
        <Skills name="JavaScript" x="20vw" y="6vw" />
        <Skills name="ReactJS" x="0vw" y="12vw" />
        <Skills name="NextJS" x="-20vw" y="-15vw" />
        <Skills name="Angular" x="15vw" y="-12vw" />
        <Skills name="Web Design" x="32vw" y="-5vw" />
        <Skills name="SwiftUI" x="0vw" y="-20vw" />
        <Skills name="Node.js" x="-25vw" y="18vw" />
